  ...
  const handlePDFDownload = async () => {
    ...
    try {
      ...
      await new Promise((resolve, reject) => {
        ...
        logoImg.src = '/lovable-uploads/c7b74152-d8c0-44a0-ab35-c7836d10e587.png';
      });
      ...
      addWrappedText('Generated by Fractionl AI\'s Ideation Blueprint Tool. Contact mindmaker@fractionl.ai for a more extensive human-in-the-loop AI strategy.', 12, false, '#6b7280');
      yPosition += 5;
